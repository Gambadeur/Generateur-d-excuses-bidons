...
function oubliList() {
    ...
    var oubliListRandom = oublieDeFaireQuelqueChose[Math.round(Math.random() * (oublieDeFaireQuelqueChose.length - 1))];

    document.querySelector("#excuses").innerHTML = "<div>" + oubliListRandom + "</div>";
...
function retardList() {
    ...
    var retardRandom = vousAvezDuRetard[Math.round(Math.random() * (vousAvezDuRetard.length - 1))];

    document.querySelector("#excuses").innerHTML = "<div>" + retardRandom + "</div>";

};

function injoingableList(){
...
var injoignableRandom = vousEtezInjoignable[Math.floor(Math.random() * vousEtezInjoignable.length)]

document.querySelector("#excuses").innerHTML = "<div>" + injoignableRandom + "</div>";

}

function plusTardList(){
...
var plusTardRandom = vousRentrezPlusTardQuePrevu[Math.floor(Math.random() * vousRentrezPlusTardQuePrevu.length)];

document.querySelector("#excuses").innerHTML = "<div>" + plusTardRandom + "</div>";
